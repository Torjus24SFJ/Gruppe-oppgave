    ...
    return (
        ...
        <div className={style.page}>
            <div className={style.card_content}>
                <div className={style.head}><img className={style.head_img} src="./src/Components/BlogPreview/assets/illustration-article.svg" alt="" /></div>  {/*<--- trenger og få inn ny bilde path*/}
